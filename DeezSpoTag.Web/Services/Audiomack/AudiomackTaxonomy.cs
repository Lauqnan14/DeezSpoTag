...
internal static class AudiomackTaxonomy
{
    ...
    internal static AudiomackSongCandidate Merge(AudiomackSongCandidate current, AudiomackSongCandidate richer)
    {
        ...
        return current with
        {
            ...
            UploaderId = FirstNonEmpty(current.UploaderId, richer.UploaderId),
            Upc = FirstNonEmpty(current.Upc, richer.Upc),
            Explicit = FirstNonEmpty(current.Explicit, richer.Explicit),
