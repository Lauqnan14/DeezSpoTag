...
public static class TaggingProfileCanonicalizer
{
    ...
    [
        ...
        new("publisher", c => c.Publisher, (c, v) => c.Publisher = v),
        new("description", c => c.Description, (c, v) => c.Description = v, "comment", "comments"),
        ...
        new("recordingId", c => c.RecordingId, (c, v) => c.RecordingId = v),
        new("artistId", c => c.ArtistId, (c, v) => c.ArtistId = v),
        new("albumArtistId", c => c.AlbumArtistId, (c, v) => c.AlbumArtistId = v),
        new("releaseGroupId", c => c.ReleaseGroupId, (c, v) => c.ReleaseGroupId = v),
        new("albumId", c => c.AlbumId, (c, v) => c.AlbumId = v),
        new("releaseStatus", c => c.ReleaseStatus, (c, v) => c.ReleaseStatus = v),
        new("releaseCountry", c => c.ReleaseCountry, (c, v) => c.ReleaseCountry = v),
        new("media", c => c.Media, (c, v) => c.Media = v),
