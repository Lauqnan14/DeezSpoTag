...
globalThis.UserPrefs = (function () {
    ...
    const KEY_TO_FIELD = {
        ...
        'deezspotag-metadata-cache-refresh-interval-days': 'metadataCacheRefreshIntervalDays',
        'deezspotag-metadata-target-update-interval-days': 'metadataTargetUpdateIntervalDays',
        'deezspotag-metadata-deep-refresh-interval-days': 'metadataDeepRefreshIntervalDays',
