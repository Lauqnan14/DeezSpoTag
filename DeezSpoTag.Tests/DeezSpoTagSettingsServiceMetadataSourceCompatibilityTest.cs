...
public sealed class DeezSpoTagSettingsServiceMetadataSourceCompatibilityTest : IDisposable
{
    private readonly string _tempRoot;
    private readonly TestConfigRootScope _configScope;
    private readonly DeezSpoTagSettingsService _settingsService;

    public DeezSpoTagSettingsServiceMetadataSourceCompatibilityTest()
    {
