...
public sealed class CoverPortSacadParityTest
{
    ...
    public void SacadComparator_PrefersSimilarToReference()
    {
        ...
        var ranked = CoverRankingService.Rank(new[] { notSimilar, similar }, SacadMode);
    ...
    public void SacadComparator_PrefersAboveTargetSizeOverBelowTarget()
    {
        ...
        var ranked = CoverRankingService.Rank(new[] { below, above }, SacadMode);
    ...
    public void SacadComparator_PrefersBetterRankWhenRelevanceEqual()
    {
        ...
        var ranked = CoverRankingService.Rank(new[] { rank5, rank0 }, SacadMode);
    ...
    public void SacadComparator_PrefersKnownMetadata()
    {
        ...
        var ranked = CoverRankingService.Rank(new[] { uncertain, known }, SacadMode);
    ...
    public void SacadComparator_PrefersPngWhenEverythingElseEqual()
    {
        ...
        var ranked = CoverRankingService.Rank(new[] { jpeg, png }, SacadMode);
