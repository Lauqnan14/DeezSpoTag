...
public sealed record MediaServerPathMappingDto(
    string Service,
    string ServerRoot,
    string LocalRoot,
    int SampleCount);
...
public sealed record WatchlistArtistDto(
    ...
    bool? DestinationFolderOverride = null,
    ...
    DownloadEngineOrderSettings? DownloadEngineOrder = null,
    IReadOnlyList<PlaylistTrackRoutingRule>? RoutingRules = null,
    long? AtmosDestinationFolderId = null,
    bool? AtmosDestinationFolderOverride = null,
